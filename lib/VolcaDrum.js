...
*/
    onSettingChange() {
      ...
      /*  if (this.settings[this.settingKey]['currentPart'] != null) {
        ...
        this.logger.initFromSetting(this.settings[this.settingKey]['key'],this.midiCCValues, this.ccsColName);
    }
...
*/
    ...
    sendMidi(cmd) {
        //console.log("sendMidi",cmd,cmd[0] >> 4 );
        ...
        if (cmd[0] >> 4 == MidiNode.CC) {
            ...
            this.logger.logMidi(part,this.ccsKey[col],val);
        }
    }
