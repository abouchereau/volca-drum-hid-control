...
module.exports = class Logger {
    ...
    createLogSessionFile() {
        ...
        fs.writeFileSync(this.LOG_DIRECTORY+"/"+this.logFileName, 'Beginning Session '+Utils.getFormattedDate(this.sessionTimeStart));
    ...
    logMidi(part, cmd, val, midiCmd) {
        ...
        if (this.logToScreen) {
            let lineTxt = "\n"+(Date.now()-this.sessionTimeStart)+";"+JSON.stringify(midiCmd);
